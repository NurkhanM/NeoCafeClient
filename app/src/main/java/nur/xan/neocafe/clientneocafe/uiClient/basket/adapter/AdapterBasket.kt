package nur.xan.neocafe.clientneocafe.uiClient.homeInfo.adapter
...
class AdapterHomeInfo(private val mIClickListnear: IClickListnearOnClick) :

    RecyclerView.Adapter<AdapterHomeInfo.TovarViewHolder>() {
